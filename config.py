...
sounds_effects = dict(
    brick_hit='sound_effects/brick_hit.mp3',
    effect_done='sound_effects/effect_done.mp3',
    paddle_hit='sound_effects/paddle_hit.mp3',
    level_complete='sound_effects/level_complete.mp3',
)
